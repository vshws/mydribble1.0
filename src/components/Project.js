...
function Project({ name, team, likes, views, img }) {
  ...
  return (
    <div className='w-full h-[320px] rounded-xl mb-5 shadow-lg' onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} >
      <div className='relative w-full h-[320px] overflow-hidden rounded-t-xl'>

    <img src={img} alt={name} className='absolute inset-0 w-full h-full object-cover rounded-t-xl'/>
        {isHovered && (
